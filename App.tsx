...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (view) {
      ...
      case "architect":
        return (
          <section className="py-32 ice-gradient min-h-screen flex items-center">
            <WorkflowArchitect />
          </section>
        );
      case "pricing":
        return (
          <section className="py-32 bg-slate-50/30 min-h-screen">
            <Pricing />
          </section>
        );
      case "documentation":
      ...
      default:
        return (
          <>
            {/* HERO: qui mettiamo SplineScene al posto del blocco bianco */}
            ...
            <section id="architect" className="py-32 ice-gradient">
              <WorkflowArchitect />
            </section>
            <section id="integrations" className="py-32">
              <Integrations />
            </section>
            <section id="pricing" className="py-32 bg-slate-50/30">
              <Pricing />
            </section>
            <section id="documentation" className="py-32">
              <Documentation setView={setView} />
            </section>
          </>
        );
    }
